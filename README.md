...
- Este repositorio contiene notas de estudio para el examen de Hacker Ético Certificado.
- Las notas son completas y están escritas con el objetivo de cubrir todas las áreas del examen.
- Incluye muchos consejos y trucos de la vida real para mantener el valor práctico del contenido.
- Combina y resume una gran cantidad de materiales educativos de muchas fuentes diferentes.
- 💡 Una buena forma de utilizar el material es utilizar la función de búsqueda de forma extensiva. Hay muchas referencias cruzadas en todo el material para ayudarte a navegar; siéntete libre de ignorarlas si estás leyendo por primera vez.
- ¡Buena suerte y disfruta estudiando! ☕
...
- There are some symbols used throughout the documentation:
  ...
  | Symbol | Description |
  |:------:|-------------|
  | 💡 | Mejores prácticas o consejos prácticos |
  | ❗ | Una limitación, un desafío o una excepción importante |
  | 📝 | Área de examen común |
  | 🤗 | Hecho/trivia (probablemente no relacionado con el examen) |
